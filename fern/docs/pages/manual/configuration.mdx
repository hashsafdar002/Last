...
While DocuChat is distributing safe and universal configuration files, you might want to quickly customize your
DocuChat, and this can be done using the `settings` files.
...
Once you've set this environment variable to the desired profile, you can simply launch your DocuChat,
