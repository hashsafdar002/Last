    ...
    with open(docs_path / "description.md") as description_file:
        ...
        def custom_openapi() -> dict[str, Any]:
            ...
            openapi_schema = get_openapi(
                ...
                version="0.1.0",
                summary="DocuChat is a production-ready AI project that allows you to "
                ...
                contact={
                    "url": "https://github.com/imartinez/DocuChat",
                },
                license_info={
                    "name": "Apache 2.0",
        ...
        if settings.ui.enabled:
            ...
            from docu_chat.ui.ui import DocuChatUi

            ui = root_injector.get(DocuChatUi)
